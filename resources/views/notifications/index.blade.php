...
<x-app-layout :title="'Notifications'">
    <div class="mb-4 flex flex-wrap items-center justify-between gap-2">
        ...
        <div class="flex gap-2">
            ...
            <form method="post" action="{{ route('notifications.destroy-all') }}" onsubmit="return confirm('Supprimer toutes les notifications ?');">
                @csrf @method('delete')
                <button type="submit" class="btn-secondary">Tout supprimer</button>
            </form>
        </div>
    </div>
