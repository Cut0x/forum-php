                    ...
                    <div class="mt-3">
                        ...
                        <div class="collapse mt-2" id="edit-<?php echo e((string) $post['id']); ?>">
                            <form method="post">
                                ...
                                <input type="hidden" name="post_id" value="<?php echo e((string) $post['id']); ?>">
                                <textarea class="form-control" name="content" rows="4" data-mentions="1" data-emotes="1" data-images="1"><?php echo e($post['content']); ?></textarea>
    ...
    <div class="card-body">
        ...
        <?php else: ?>
            <form method="post">
                ...
                <div class="mb-3">
                <textarea class="form-control" name="content" rows="4" placeholder="Votre message..." data-mentions="1" data-emotes="1" data-images="1"></textarea>
                </div>
